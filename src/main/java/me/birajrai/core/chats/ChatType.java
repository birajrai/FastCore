package me.birajrai.core.chats;
...
public enum ChatType {
    ...
    private static final FastCore plugin = FastCore.getInstance();
    ...
    public static boolean hasPermission(Player player, ChatType type) {
        return player.hasPermission("fcore.chats." + type.toString().toLowerCase());
    }
