...
public class TeleportCommands implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        switch (command.getName().toLowerCase()) {
            case "teleport":
                if (!sender.hasPermission("fcore.teleport")) {
            ...
            case "teleporthere":
                ...
                break;
            case "teleportall":
                if (!sender.hasPermission("fcore.teleport.all") && !sender.hasPermission("fcore.teleport")) {
                    sender.sendMessage(Utils.translate(plugin.getConfig().getString("Teleport.NoPermission")));
                    return true;
                }
                ...
                break;
            case "teleporta":
                if (!sender.hasPermission("fcore.teleportrequest")) {
                    sender.sendMessage(Utils.translate(plugin.getConfig().getString("Teleport.NoPermission")));
                    return true;
                }
