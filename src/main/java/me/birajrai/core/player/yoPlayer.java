package me.birajrai.core.player;
...
public class yoPlayer {
    ...
    public yoPlayer(OfflinePlayer player) {
        this.player = player;
    }

    public static yoPlayer getYoPlayer(OfflinePlayer player) {
        return new yoPlayer(player);
    }
    ...
    public static yoPlayer getYoPlayer(String name) {
        return new yoPlayer(name);
    }
    ...
    public Rank getRank() {
        return Rank.getRank(plugin.playerData.config.getString(getPlayer().getUniqueId().toString() + ".Rank"));
    }
    ...
    public boolean isRankDisguised() {
        return plugin.rank_disguise.containsKey(getPlayer().getUniqueId());
    }

    public Rank getRankDisguise() {
        return plugin.rank_disguise.get(getPlayer().getUniqueId());
    }

    public void setRankDisguise(Rank rank) {
        plugin.rank_disguise.put(getPlayer().getUniqueId(), rank);
    }
    ...
    public String getDisplayNickname() {
        return plugin.getConfig().getString("Nickname.NickPrefix") + getNickname();
    }
    ...
    public String getIP() {
        return plugin.playerData.config.getString(getPlayer().getUniqueId().toString() + ".IP");
    }
    ...
    public List<String> getAllIPs() {
        return plugin.playerData.config.getStringList(getPlayer().getUniqueId().toString() + ".TotalIPs");
    }
    ...
    public boolean isNicked() {
        return plugin.nickname.containsKey(getPlayer().getUniqueId());
    }

    public String getNickname() {
        return plugin.nickname.get(getPlayer().getUniqueId());
    }
    ...
    public long getFirstJoined() {
        return plugin.playerData.config.getLong(getPlayer().getUniqueId().toString() + ".FirstJoined");
    }
